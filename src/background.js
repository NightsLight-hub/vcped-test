...
function startControlIpc (browserWindow) {
...
function startExpress (browserWindow) {
  ...
  arserver.get('/api/msg/:word', (req, res) => {
    console.log(req.params.word);
    browserWindow.webContents.send('mainMsg', req.params.word);
    res.send('ok');
  });
  const port = 20300;
